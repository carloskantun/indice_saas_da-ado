...
$mes_terminados = obtener("SELECT COUNT(*) AS total FROM ordenes_mantenimiento $where AND estatus = 'Terminado' AND DATE_FORMAT(fecha_reporte, '%Y-%m') = '$mes'", $conn);
$cumplimiento_mes = ($mes_total > 0) ? round(($mes_terminados / $mes_total) * 100, 1) : 0;

$html = "
<h2 style='text-align:center;'>📊 KPIs de Mantenimiento</h2>
<table border='1' cellpadding='8' cellspacing='0' style='width:100%; font-family:sans-serif; font-size:14px;'>
<tr><th>Indicador</th><th>Valor</th></tr>
<tr><td>Total Reportes</td><td>$total</td></tr>
<tr><td>Pendientes</td><td>$pendientes</td></tr>
<tr><td>En Proceso</td><td>$proceso</td></tr>
<tr><td>Terminados</td><td>$terminados</td></tr>
<tr><td>Cancelados</td><td>$cancelados</td></tr>
<tr><td>Vencidos</td><td>$vencidos</td></tr>
...
$dompdf->render();
$dompdf->stream("kpis_mantenimiento_" . date("Ymd") . ".pdf", ["Attachment" => 0]);
exit;